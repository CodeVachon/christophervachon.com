<cfoutput>
	<h2><cfif structKeyExists(RC,"month")>#monthAsString(RC.month)# </cfif><cfif structKeyExists(RC,"year")>#RC.year# </cfif>Blog Entries<cfif RC.page GT 1>: Page #RC.page#</cfif></h2>
