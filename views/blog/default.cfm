<cfoutput>
	<h2><cfif structKeyExists(RC,"month") && isNumeric(RC.month)>#monthAsString(int(RC.month))# </cfif><cfif structKeyExists(RC,"year")>#RC.year# </cfif>Blog Entries<cfif RC.page GT 1>: Page #RC.page#</cfif></h2>
